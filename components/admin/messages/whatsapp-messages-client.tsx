            ...
            >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {!isApiMode && (
                    <span className="inline-flex items-center h-5 px-2 rounded-full text-[10px] font-bold bg-amber-500/15 text-amber-500 border border-amber-500/25 mt-1">
                      قريباً
                    </span>
                  )}
                </div>
...
function StatusBadge({
  ...
  return (
    <span className="inline-flex items-center h-5 px-2 rounded-full text-[10px] font-bold bg-accent/15 text-accent border border-accent/25 mt-1">
      مفعّل
    </span>
  );
}
