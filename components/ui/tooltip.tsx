...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        // Always-dark tooltip — readable on every theme.
        "z-50 overflow-hidden rounded-lg bg-[hsl(222_22%_9%)] px-2.5 py-1.5 text-xs font-medium text-white",
        "shadow-[0_8px_22px_-8px_rgba(15,23,32,0.45)]",
